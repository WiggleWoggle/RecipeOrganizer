...
namespace RecipeOrganizer
{
    internal class RecipeManager
    {
        ...
        {
            recipes.Add(new Recipe(1, "Tteok-bokki", "https://futuredish.com/wp-content/uploads/Tteokbokki-3a.jpg", new DateTime(), "Korean", "Any", new List<String>(), new List<String>(), new List<String> { "Korea", "Korean", "Korean Food", "Spicy" }));
            ...
            recipes.Add(new Recipe(3, "Baozi", "https://thewoksoflife.com/wp-content/uploads/2019/06/pork-baozi-11.jpg", new DateTime(), "Chinese", "Any", new List<String>(), new List<String>(), new List<String> { "China", "Chinese", "Chinese Food", "Steamed", "Pork", "Buns" }));
        }
    }
}
